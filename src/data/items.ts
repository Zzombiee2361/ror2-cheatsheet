import { Category, ItemRarity, SelectionType, StackType, Tag } from './constants';
...
export interface Item {
  ...
  description: string
  itemType?: typeof SelectionType[keyof typeof SelectionType]
  itemRarity: typeof ItemRarity[keyof typeof ItemRarity]
  ...
  stats: {
    stat: string
    value: string
    stackType: typeof StackType[keyof typeof StackType]
    stackValue: string
  }[]
}
...
export const allItems = Object.freeze([
  ...Object.values(items).map((item) => ({ ...item, itemType: SelectionType.ITEM })),
  ...Object.values(sotv).map((item) => ({ ...item, itemType: SelectionType.SOTV })),
]);
